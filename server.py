...
import certifi
import os
from websockets.legacy.server import WebSocketServerProtocol, serve as legacy_serve
...
WS_PORT = int(os.environ.get("PORT", 8080))  # Cloud Run injects PORT env variable
...
async def start_websocket_server():
    ...
    async with legacy_serve(handle_websocket_client, "0.0.0.0", WS_PORT):
